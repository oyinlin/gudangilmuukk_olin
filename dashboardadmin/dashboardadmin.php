...
<header class="row w-100 z-3 position-fixed justify-content-between align-items-center py-2 p-0 m-0" style="background-color: #A5CEE8 ; width:90px;">
    ...
    <div class="sidenav mt-5">
        ...
        <br>
        <a onclick="location.href='akunPetugas/buatakunpetugas.php';"><i class=" cardImg fas fa-user-plus"></i> Buat Akun Petugas</a>
        <br>
    ...
    <div class="mt-3 p-4" style="margin-left: 220px;">
        <h1 class="mt-5 fw-bold">Selamat Datang Admin <span class="fs-4 text-secondary"></span></h1>
        <div class="d-flex">
